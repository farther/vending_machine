class VendingMachine
  attr_accessor :machine_money, :machine_balance, :items, :item_prices, :user_money, :user_balance
  ...
  def check_change
    ...
    if @machine_balance < change_amount
      raise StandardError, "Sorry I did not have change for you, take your money back"
    end
    ...
    while change_amount > 0 do
      ...
      raise StandardError, "Sorry I did not have change for you, take your money back" if next_step_var == change_amount
      next_step_var = change_amount
    end
  end
